...
function getDestinationFromDestinationService(options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, DestinationFromServiceRetriever.getDestinationFromDestinationService(options)];
        });
    });
}
...
var DestinationFromServiceRetriever = /** @class */ (function () {
    ...
    DestinationFromServiceRetriever.getDestinationFromDestinationService = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, subscriberToken, xsuaaCredentials, providerToken, da, destinationResult, destination, _b, withProxySetting;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(0, identity_service_1.isTokenExchangeEnabled)(options)) return [3 /*break*/, 2];
                        _a = options;
                        return [4 /*yield*/, (0, identity_service_1.exchangeToken)(options)];
                    case 1:
                        _a.jwt = _c.sent();
                        _c.label = 2;
                    case 2: return [4 /*yield*/, DestinationFromServiceRetriever.getSubscriberToken(options)];
                    case 3:
                        subscriberToken = _c.sent();
                        xsuaaCredentials = (0, environment_accessor_1.getXsuaaServiceCredentials)(options.jwt);
                        return [4 /*yield*/, DestinationFromServiceRetriever.getProviderClientCredentialsToken(xsuaaCredentials, options)];
                    case 4:
                        providerToken = _c.sent();
                        da = new DestinationFromServiceRetriever(options.destinationName, __assign(__assign({}, options), { xsuaaCredentials: xsuaaCredentials }), subscriberToken, providerToken);
                    ...
                    case 5:
                        ...
                        if (!(destination.authentication === 'OAuth2SAMLBearerAssertion')) return [3 /*break*/, 9];
                    ...
                    case 8:
                      ...
                      */
                        ...
                        _c.label = 9;
                    case 9:
                        if (!(destination.authentication === 'OAuth2UserTokenExchange')) return [3 /*break*/, 11];
                    ...
                    case 11:
                        if (!(destination.authentication === 'OAuth2ClientCredentials' ||
                            destination.authentication === 'OAuth2Password')) return [3 /*break*/, 13];
                        return [4 /*yield*/, da.fetchDestinationByClientCrendentialsGrant()];
                    case 12:
                        destination = _c.sent();
                        _c.label = 13;
                    case 13:
                        if (!(destination.authentication === 'OAuth2JWTBearer')) return [3 /*break*/, 15];
                        return [4 /*yield*/, da.fetchDestinationByUserJwt()];
                    case 14:
                        destination = _c.sent();
                        _c.label = 15;
                    case 15:
                        if (!(destination.authentication === 'ClientCertificateAuthentication')) return [3 /*break*/, 17];
                        return [4 /*yield*/, da.addClientCertAuth(destinationResult.origin)];
                    case 16:
                        destination = _c.sent();
                        _c.label = 17;
                    case 17: return [4 /*yield*/, da.addProxyConfiguration(destination)];
                    case 18:
    ...
    DestinationFromServiceRetriever.getProviderClientCredentialsToken = function (xsuaaCredentials, options) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    DestinationFromServiceRetriever.getSubscriberClientCredentialsToken = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, (0, token_accessor_1.serviceToken)('destination', options)];
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = {};
                        return [4 /*yield*/, (0, token_accessor_1.jwtBearerToken)(this.subscriberToken.encoded, (0, environment_accessor_1.getDestinationService)(), this.options)];
    ...
    DestinationFromServiceRetriever.prototype.fetchDestinationByClientCrendentialsGrant = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, token_accessor_1.serviceToken)('destination', {
                            jwt: ((_a = this === null || this === void 0 ? void 0 : this.subscriberToken) === null || _a === void 0 ? void 0 : _a.decoded) ||
    ...
    DestinationFromServiceRetriever.prototype.fetchDestinationByUserJwt = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        destinationService = (0, environment_accessor_1.getDestinationService)();
                        ...
                        return [4 /*yield*/, (0, token_accessor_1.jwtBearerToken)(this.subscriberToken.encoded, destinationService, this.options)];
                    case 1:
                        accessToken = _a.sent();
    ...
    DestinationFromServiceRetriever.prototype.addClientCertAuth = function (origin) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, token_accessor_1.serviceToken)('destination', __assign(__assign({}, this.options), { jwt: origin === 'subscriber'
                                ? this.subscriberToken.decoded
                                : this.providerClientCredentialsToken.decoded }))];
                    case 1:
                        accessToken = _a.sent();
                        return [2 /*return*/, (0, destination_service_1.fetchDestination)(this.destinationServiceCredentials.uri, accessToken, this.name, this.options)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch ((0, proxy_util_1.proxyStrategy)(destination)) {
                    case proxy_util_1.ProxyStrategy.ON_PREMISE_PROXY:
                        return [2 /*return*/, (0, connectivity_service_1.addProxyConfigurationOnPrem)(destination, this.subscriberToken)];
                    case proxy_util_1.ProxyStrategy.INTERNET_PROXY:
                        return [2 /*return*/, (0, proxy_util_1.addProxyConfigurationInternet)(destination)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, token_accessor_1.serviceToken)('destination', __assign(__assign({}, this.options), { jwt: this.subscriberToken.decoded }))];
                    case 1:
                        accessToken = _a.sent();
    ...
    DestinationFromServiceRetriever.prototype.isProviderAndSubscriberSameTenant = function () {
        return (this.subscriberToken &&
            (0, tenant_1.isIdenticalTenant)(this.subscriberToken.decoded, this.providerClientCredentialsToken.decoded));
    };
