 ...
 * @internal
 */
function getDestinationFromDestinationService(options) {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      logger.info(
        'Attempting to retrieve destination from destination service.'
      );
      return [
        2 /*return*/,
        DestinationFromServiceRetriever.getDestinationFromDestinationService(
          options
        )
      ];
    });
...
exports.getDestinationFromDestinationService =
  getDestinationFromDestinationService;
/**
 * @internal
 */
var DestinationFromServiceRetriever = /** @class */ (function () {
  function DestinationFromServiceRetriever(
    name,
    options,
    subscriberToken,
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                (0, identity_service_1.exchangeToken)(options)
              ];
            case 1:
              _a.jwt = _c.sent();
              _c.label = 2;
            case 2:
              return [
                4 /*yield*/,
                DestinationFromServiceRetriever.getSubscriberToken(options)
              ];
            case 3:
              subscriberToken = _c.sent();
              xsuaaCredentials = (0,
              environment_accessor_1.getXsuaaServiceCredentials)(options.jwt);
              return [
                4 /*yield*/,
                DestinationFromServiceRetriever.getProviderClientCredentialsToken(
                  xsuaaCredentials,
                  options
                )
              ];
            case 4:
              ...
              da = new DestinationFromServiceRetriever(
              ...
              return [
                4 /*yield*/,
                da.searchDestinationWithSelectionStrategyAndCache()
              ];
            case 5:
              destinationResult = _c.sent();
              ...
              return [
                4 /*yield*/,
                da.fetchDestinationBySystemUser(destinationResult)
              ];
            case 6:
              _b = _c.sent();
            ...
            case 9:
              ...
              return [
                4 /*yield*/,
                da.fetchDestinationByUserTokenExchange(destinationResult.origin)
              ];
            case 10:
              destination = _c.sent();
              _c.label = 11;
            case 11:
              ...
              return [
                4 /*yield*/,
                da.fetchDestinationByClientCrendentialsGrant()
              ];
            case 12:
              destination = _c.sent();
              _c.label = 13;
            ...
            case 15:
              ...
              return [
                4 /*yield*/,
                da.addClientCertAuth(destinationResult.origin)
              ];
            case 16:
              destination = _c.sent();
              _c.label = 17;
            case 17:
              return [4 /*yield*/, da.addProxyConfiguration(destination)];
            case 18:
              withProxySetting = _c.sent();
              da.updateDestinationCache(
                withProxySetting,
  ...
  DestinationFromServiceRetriever.getSubscriberToken = function (options) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            if (!options.jwt) return [3 /*break*/, 2];
            if (options.iss) {
              logger.warn(
            ...
            _a = {};
            return [4 /*yield*/, (0, jwt_1.verifyJwt)(options.jwt, options)];
          case 1:
            return [
              2 /*return*/,
              ((_a.decoded = _b.sent()), (_a.encoded = options.jwt), _a)
            ];
          case 2:
            if (options.iss) {
              logger.info(
              ...
              return [
                ...
                {
                  decoded: payload,
                  encoded: (0, util_1.encodeBase64)(JSON.stringify(payload))
                }
              ];
            }
            return [2 /*return*/];
  ...
  DestinationFromServiceRetriever.getProviderClientCredentialsToken = function (
    xsuaaCredentials,
    options
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var jwt, optionsWithoutJwt, encoded;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            (jwt = options.jwt), (optionsWithoutJwt = __rest(options, ['jwt']));
            return [
              4 /*yield*/,
              (0, token_accessor_1.serviceToken)(
                'destination',
                __assign(__assign({}, optionsWithoutJwt), {
                  xsuaaCredentials: xsuaaCredentials
                })
              )
            ];
          case 1:
            ...
            return [
              2 /*return*/,
              { encoded: encoded, decoded: (0, jwt_1.decodeJwt)(encoded) }
            ];
        }
      });
    });
  };
  DestinationFromServiceRetriever.getSubscriberClientCredentialsToken =
    function (options) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          if (!options.jwt) {
          ...
          return [
            2 /*return*/,
            (0, token_accessor_1.serviceToken)('destination', options)
          ];
        });
      });
    };
  DestinationFromServiceRetriever.prototype.searchDestinationWithSelectionStrategyAndCache =
    function () {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this.searchSubscriberAccountForDestination()
              ];
            case 1:
            ...
            case 4:
              if (
                ...
                !destinationSearchResult.fromCache
              ) {
                logger.debug(
              ...
              if (
                ...
                logger.debug(
                  'Successfully retrieved destination from destination service cache for ' +
                    destinationSearchResult.origin +
                    ' destinations.'
                );
              }
              if (!destinationSearchResult) {
                logger.info(
                  'Could not retrieve destination from destination service.'
                );
              }
  ...
  DestinationFromServiceRetriever.prototype.getInstanceAndSubaccountDestinations =
          ...
          switch (_b.label) {
            case 0:
              return [
                4 /*yield*/,
                Promise.all([
                  (0, destination_service_1.fetchInstanceDestinations)(
                    this.destinationServiceCredentials.uri,
                    accessToken,
                    this.options
                  ),
                  (0, destination_service_1.fetchSubaccountDestinations)(
                    this.destinationServiceCredentials.uri,
                    accessToken,
                    this.options
                  )
  ...
  Object.defineProperty(
    DestinationFromServiceRetriever.prototype,
    'destinationServiceCredentials',
    {
      get: function () {
        var credentials = (0,
        environment_accessor_1.getDestinationServiceCredentialsList)();
  ...
  DestinationFromServiceRetriever.prototype.fetchDestinationByToken = function (
    jwt
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          (0, destination_service_1.fetchDestination)(
            this.destinationServiceCredentials.uri,
            jwt,
            this.name,
            this.options
  ...
  DestinationFromServiceRetriever.prototype.getAuthTokenForOAuth2UserTokenExchange =
    function (destinationOrigin) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              if (!(0, jwt_1.isUserToken)(this.subscriberToken)) {
                throw Error(
              ...
              if (!this.isProviderAndSubscriberSameTenant())
                return [3 /*break*/, 2];
              logger.debug(
                'OAuth2UserTokenExchange flow started without user exchange token for destination ' +
                  this.name +
              ...
              return [
                4 /*yield*/,
                (0, token_accessor_1.jwtBearerToken)(
                  this.subscriberToken.encoded,
                  (0, environment_accessor_1.getDestinationService)(),
                  this.options
                )
              ];
            case 1:
              return [2 /*return*/, ((_a.authHeaderJwt = _c.sent()), _a)];
            case 2:
              // Case 2 Destination in provider and jwt issued for subscriber account
              if (destinationOrigin === 'provider') {
                logger.debug(
                  'OAuth2UserTokenExchange flow started for destination ' +
                    this.name +
                    ' of the provider account.'
                );
                return [
  ...
  DestinationFromServiceRetriever.prototype.fetchDestinationByUserTokenExchange =
    function (destinationOrigin) {
      return __awaiter(this, void 0, void 0, function () {
        var token;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                this.getAuthTokenForOAuth2UserTokenExchange(destinationOrigin)
              ];
            case 1:
              token = _a.sent();
   ...
   */
  DestinationFromServiceRetriever.prototype.fetchDestinationByClientCrendentialsGrant =
    function () {
      var _a;
      return __awaiter(this, void 0, void 0, function () {
        var clientGrant;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              return [
                4 /*yield*/,
                (0, token_accessor_1.serviceToken)('destination', {
                  jwt:
                    ((_a =
                      this === null || this === void 0
                        ? void 0
                        : this.subscriberToken) === null || _a === void 0
                      ? void 0
                      : _a.decoded) ||
  ...
  DestinationFromServiceRetriever.prototype.fetchDestinationBySystemUser =
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 3:
              token = _a;
              logger.debug(
                'System user found on destination: "' +
                  destinationResult.destination.name +
                  '".'
              );
  ...
  DestinationFromServiceRetriever.prototype.fetchDestinationByUserJwt =
    function () {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              destinationService = (0,
              environment_accessor_1.getDestinationService)();
  ...
  DestinationFromServiceRetriever.prototype.addProxyConfiguration = function (
    destination
  ) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch ((0, proxy_util_1.proxyStrategy)(destination)) {
          case proxy_util_1.ProxyStrategy.ON_PREMISE_PROXY:
            return [
              2 /*return*/,
              (0, connectivity_service_1.addProxyConfigurationOnPrem)(
                destination,
  ...
  DestinationFromServiceRetriever.prototype.updateDestinationCache = function (
    destination,
    destinationOrigin
  ) {
    ...
    destination_cache_1.destinationCache.cacheRetrievedDestination(
  ...
  DestinationFromServiceRetriever.prototype.getProviderDestinationService =
    function () {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [
                4 /*yield*/,
                this.getInstanceAndSubaccountDestinations(
  ...
  DestinationFromServiceRetriever.prototype.getProviderDestinationCache =
    function () {
      var destination =
        destination_cache_1.destinationCache.retrieveDestinationFromCache(
          this.providerClientCredentialsToken.decoded,
          this.name,
          this.options.isolationStrategy
        );
  ...
  DestinationFromServiceRetriever.prototype.getSubscriberDestinationService =
    function () {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                4 /*yield*/,
                this.getInstanceAndSubaccountDestinations(accessToken)
              ];
            case 2:
              subscriber = _a.sent();
              destination = this.options.selectionStrategy(
  ...
  DestinationFromServiceRetriever.prototype.getSubscriberDestinationCache =
    function () {
      var destination =
        destination_cache_1.destinationCache.retrieveDestinationFromCache(
          this.subscriberToken.decoded,
  ...
  DestinationFromServiceRetriever.prototype.isProviderAndSubscriberSameTenant =
    function () {
      return (
        this.subscriberToken &&
        (0, tenant_1.isIdenticalTenant)(
          this.subscriberToken.decoded,
          this.providerClientCredentialsToken.decoded
        )
      );
    };
  DestinationFromServiceRetriever.prototype.isProviderNeeded = function (
    resultFromSubscriber
  ) {
    if (
      this.options.selectionStrategy ===
      destination_selection_strategies_1.alwaysSubscriber
    ) {
      return false;
    }
    if (
  ...
  DestinationFromServiceRetriever.prototype.isSubscriberNeeded = function () {
    ...
    if (
      this.options.selectionStrategy ===
      destination_selection_strategies_1.alwaysProvider
    ) {
      return false;
    }
    return true;
  };
  DestinationFromServiceRetriever.prototype.searchProviderAccountForDestination =
    function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
  ...
  DestinationFromServiceRetriever.prototype.searchSubscriberAccountForDestination =
    function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          return [
